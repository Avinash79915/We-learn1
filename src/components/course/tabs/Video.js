    ...
    return (
        <div className="flex flex-col w-full mx-auto">
            ...
            <section className="my-4 text-accent-content">
                ...
                <p className="text-sm mt-1">We learn is a website where you can find top-rated tech videos and tutorials in the form of a course.</p>
                ...
                <p className="text-sm mt-3">
                    ...
                    We learn helps you sail through the endless ocean of tech resources on YouTube. </p>
            </section>
